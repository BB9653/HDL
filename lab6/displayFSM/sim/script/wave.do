...
add wave -noupdate /display_tb/uut/clk
add wave -noupdate /display_tb/uut/reset
add wave -noupdate -radix unsigned /display_tb/uut/a
add wave -noupdate -radix unsigned /display_tb/uut/b
add wave -noupdate /display_tb/uut/state_change
add wave -noupdate /display_tb/uut/HEX0
add wave -noupdate /display_tb/uut/HEX1
add wave -noupdate /display_tb/uut/HEX2
add wave -noupdate /display_tb/uut/state
